...
<tbody>
 <?php foreach($search_results as $auto) : ?>
  ...
  <td><?php echo $auto->fabricante;?></td> 
   ...
   <td class="actions">
    <a href="<?php echo base_url('frota/editar/'.$auto->id) ?>" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
    <a href="<?php echo base_url('frota/remover/'.$auto->id) ?>" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" <?php if ($auto->disponibilidade == '0'){ ?> disabled <?php } ?> ><span class="glyphicon glyphicon-trash"></span></a>
    </td>
    </tr>
  <?php endforeach; ?> 
  </tbody>
